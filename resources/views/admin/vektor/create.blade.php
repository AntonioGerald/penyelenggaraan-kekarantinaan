<x-app-layout>
    ...
    <div class="py-4">
        <div class="container">
            <form method="POST" action="{{ route('admin.vektor.store') }}" class="card card-body border-0 shadow-sm">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="lalat" class="form-control @error('lalat') is-invalid @enderror" value="{{ old('lalat') }}" min="0">
                        @error('lalat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="kecoa" class="form-control @error('kecoa') is-invalid @enderror" value="{{ old('kecoa') }}" min="0">
                        @error('kecoa')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="jentik_dbd" class="form-control @error('jentik_dbd') is-invalid @enderror" value="{{ old('jentik_dbd') }}" min="0">
                        @error('jentik_dbd')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
